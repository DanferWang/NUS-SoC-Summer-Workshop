...
def train(model_file,train_path,validation_path,num_hidden=200,num_classes=5,steps=32,num_epochs=20,save_period=1):
	...
	model.compile(optimizers='rmsprop',loss='categorical_crossentropy')
...
def main():
	train(MODEL_FILE,train_path="flower_photos",validation_path="flower_photos",steps=120,num_hidden=10)
